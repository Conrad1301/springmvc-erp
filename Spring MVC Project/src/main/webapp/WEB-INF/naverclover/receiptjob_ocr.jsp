...
<script
	...
	$(document).ready(function() {
		$("#upload").click(function() {
			...
			//FormData객체는 <form></form>의 모든 key와 value가 저장된 객체
			//<form>태크처럼 데이터가 처리되도록 지원
			//이 FormData객체를 Ajax로 전송하면 <form>객체 내부에서 데이터 전송된 것과 동일한 효과
			...
			//=> 아이디와 부서명을 전달
			//=> 아이디와 부서명은 로그인이 완료된 후에 세션에 저장되어있는 것을 꺼내와야 한다.
			var id = "${user.id}";
